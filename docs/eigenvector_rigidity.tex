...
All code and data are available at \url{https://github.com/jvaughan/riemann}.
...
\bibitem{CompanionPairCorr}
Claude and J.~Vaughan,
Quantitative structure of the finite-$T$ pair correlation correction for Riemann zeta zeros, preprint, 2026.

\bibitem{CompanionGamma}
Claude and J.~Vaughan,
Spectral evidence for the Nyman--Beurling criterion: stabilization of the overlap exponent~$\gamma$, preprint, 2026.

\bibitem{CompanionOperator}
Claude and J.~Vaughan,
Gauge symmetry, arithmetic modes, and analytic continuation: toward the Hilbert--P\'olya operator via the explicit formula, preprint, 2026.
