...
\subsection{Toward RH}
To strengthen $f \leq 6.4\%$ to $f = 0$ requires computing $r_0$ (the on-line value) \emph{a priori} from the Riemann--Siegel sum structure, to precision $\varepsilon < C/N$.
This is a well-posed problem in the harmonic analysis of cosine sums with $1/\sqrt{n}$ weights and $\log n$ frequencies, modulated by the Riemann--Siegel phase.
